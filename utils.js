...
// remove diacritics (accented strings)
function removeDiacritics(str, toLower) {
    ...
    // loops the string replacing diacritics
    for (var i = 0; i < defaultDiacriticsRemovalMap.length; i++) {
        str = str.replace(defaultDiacriticsRemovalMap[i].letters, defaultDiacriticsRemovalMap[i].base);
    }

    // checks if should return lower case or leave unchanged
    if (toLower) {
